$(function() {
    $("<style>", {
        ...
        html: [$("<div>", {
            ...
            html: [$("<div>", {
                class: "loading_td",
                html: '<img class="avatar-loader ls-is-cached lazyload" src="https://img.upanh.tv/2024/10/28/heart-493_256.gif" data-src="//i.imgur.com/FeU1IWC.png">'
            }), $("<div>", {
                class: "pjax_title",
                html: '\uD835\uDDEA\uD835\uDE00x\uD835\uDDDF\uD835\uDDFC\uD835\uDDEE\uD835\uDDF1\uD835\uDDF2\uD835\uDDFF'
            }), $("<div>", {
                ...
                html: '<span style="font-size:17px;">Äang táº£i t\xe0i nguy\xean...</span>'
            }), ]
        }), ]
        ...
        $("#loading_msg").fadeOut(500).fadeIn(500).fadeOut(500, () => {
            $("#loading_msg").html('<span style="font-size: 17px;">Äá»£i m\xecnh 1 x\xedu :)</span>').fadeIn(1e3).fadeOut(500).fadeIn(500).fadeOut(500, () => {
                $("#loading_msg").html('<span style="font-size: 17px;">Sáº¯p táº£i dá»¯ liá»‡u xong</span>').fadeIn()
            })
        })
    }, 1e3)
});
